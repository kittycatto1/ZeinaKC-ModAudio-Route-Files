...
| _mu_haven                   | _sound/_musics/_mu_haven.ogg                   | Tuul Valley song.                                                   |
| _ambClave                   | _sound/_ambience/_ambClave.ogg                 | Tuul Enclave song.                                                  |
| _mu_encoderStrife           | _sound/_musics/_mu_encoderStrife.ogg           | Bularr Fortress song.                                               |
| _atlyssSet_track01          | _sound/_musics/_atlyssSet_track01.ogg          | Wall of the Stars song.                                             |
...
| _mu_hermit                  | _sound/_musics/_mu_hermit.ogg                  | Galius boss song in Bularr Fortress.                                |
| music_whisper               | _sound/_musics/music_whisper.ogg               | Dungeon boss defeated song.                                         |
| _mu_haven                   | _sound/_musics/_mu_haven.ogg                   | Sanctum Arena song. (available in ModAudio, but unused in ATLYSS)   |
| _mu_hell01                  | _sound/_musics/_mu_hell01.ogg                  | Executioner's Tomb song. (available in ModAudio. Unused in ATLYSS)  |
